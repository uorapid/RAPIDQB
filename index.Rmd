...
data.raw2$'Jump to Module' <- paste0("<a href='",data.raw$'Jump to Module',"'>", data.raw2$'Jump to Module',"</a>")
```
...
<p style="font-size:14pt">We began using a module system to our follow-up surveys starting week 33. Below is a key that provides a brief summary of each module as well as a link to the questions for that module on the site. You can also use the navigation bar to switch between modules.</p>
