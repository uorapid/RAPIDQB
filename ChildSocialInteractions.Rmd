...
data.raw <- read_excel("Data/ChildSocialInteractions.xlsx")
...
Instructions: The next set of questions are about your child(ren)'s between the ages of 0-5 social interactions. 
